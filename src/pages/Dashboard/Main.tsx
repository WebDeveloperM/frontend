                ...
                <>
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-5 2xl:gap-7.5">
                        ...
                        <CardDataStats title="Все компьютеры" total={`${infoCompData?.all_compyuters_count}`}
                                       setSelectKey={handleSelectKey} isLoading={isCardFilterLoading && selectKey === "Все компьютеры"}>
                        ...
                        <CardDataStats title="Рабочие компьютеры" total={`${infoCompData?.all_worked_compyuters_count}`}
                                       setSelectKey={handleSelectKey} isLoading={isCardFilterLoading && selectKey === "Рабочие компьютеры"}>
