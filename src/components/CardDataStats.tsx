...
const CardDataStats: React.FC<CardDataStatsProps> = ({
  ...
  return (
    <div 
      onClick={() => !isLoading && setSelectKey(title)} 
      className={`rounded-sm border duration-200 border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark ${
